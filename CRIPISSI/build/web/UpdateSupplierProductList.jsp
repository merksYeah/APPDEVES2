          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Select Supplier</h4>
                           <form action = "ToUpdateSupplier2" class="form-horizontal style-form" method="post"> 
                               <div class="form-group">
                              <label class="col-lg-3 col-sm-3 control-label">Choose Supplier to Update</label>
                                <div class="col-lg-3 col-sm-3 input-group">
                                    <select name ="suppName" class="form-control" required onchange="this.form.submit()">
                                        <option></option>
                          ...
                          <div class="form-group">
                              <label class="col-lg-2 col-sm-2 control-label">Supplier TIN</label>
                                <div class="col-lg-3 col-sm-3 input-group">
                                     <input name = "customertin" type="text" id="disabledInput" class="form-control" value="<c:out value="${supp.supplierTin}"/>" rows="1"  readonly>
                                    <span class="input-group-btn"> 
                                   <button data-toggle="modal" href="NewPurchaseOrder.html#myModal" class="btn btn-round btn-primary" type="button">Current Product List</button>
                                    </span>
                                  
                                </div>
                          </div>
                                       
                           <h4 class="mb"><i class="fa fa-angle-right"></i> Choose Products to add to Supplier List</h4>             
