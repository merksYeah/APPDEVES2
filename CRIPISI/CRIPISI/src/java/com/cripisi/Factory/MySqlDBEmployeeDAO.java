...
public class MySqlDBEmployeeDAO implements EmployeeDAO {
     ...
     private static final String SQL_GET_EMPLOYEEID_EMPLOYEE = "Select employeeId, first_name,last_name, job_position from employee where employeeId = ?";
    ...
    public void insertEmployee(Employee employee1){
         try {
            ...
            pstmt.setInt(1, employee1.getEmployeeId());
     ...
     @Override
      public ArrayList<Employee> getEmployeestByPosition(Employee employee1){
            ...
            while(rs.next())
             {
                ...
                employee2.setEmployeeId(rs.getInt("employeeId"));
       ...
       @Override
      public ArrayList<Employee> getEmployeeById(Employee employee1){
            ResultSet rs = null;
           ArrayList<Employee> ListEmployees = new ArrayList<>();
          try {
            PreparedStatement pstmt = MySqlDbDAOFactory.createConnection().prepareStatement( SQL_GET_EMPLOYEEID_EMPLOYEE );
            pstmt.setInt(1, employee1.getEmployeeId());
            rs = pstmt.executeQuery();
            while(rs.next())
            {
