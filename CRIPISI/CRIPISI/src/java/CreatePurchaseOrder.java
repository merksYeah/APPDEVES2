...
public class CreatePurchaseOrder extends HttpServlet{
     ...
     protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           purchase.setSupplierID(Integer.parseInt(request.getParameter("suppliertin")));
          //purchase.setDeliver_to(request.getParameter("address")); 
           Date d = java.sql.Date.valueOf(request.getParameter("orderdate"));
           purchase.setOrder_date(d);
           DAOFactory what =  DAOFactory.getDAOFactory(1);
           PurchaseOrderDAO po = what.getPurchaseOrderDAO();
           int ordernumber = po.addPurchaseOrder(purchase);
           purchase.setPurchaseOrderID(ordernumber);
           purchase.setProducts(Products);
           purchase.setQuantity(Quantity);
           po.addProducts(purchase);
